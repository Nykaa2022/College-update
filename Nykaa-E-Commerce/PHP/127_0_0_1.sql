...
--
CREATE DATABASE IF NOT EXISTS `ecommerce_pro` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `ecommerce_pro`;
...
('root', '[{\"db\":\"ecommerce_pro\",\"table\":\"product\"},{\"db\":\"ecommerce_pro\",\"table\":\"login\"}]');
...
('root', '2022-06-22 07:35:49', '{\"Console\\/Mode\":\"collapse\"}');
